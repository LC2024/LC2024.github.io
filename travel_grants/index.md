...
{% comment %}The student travel application (with accompanying recommendation letter) should be emailed to [info@lc2024.se](mailto:info@lc2024.se) as **a single pdf file** with **"travel grant application" in the subject** no later than **February 29, 2024**. {% endcomment %}
